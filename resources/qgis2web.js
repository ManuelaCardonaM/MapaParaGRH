...
map.getView().fit([-6354061.656041, -4134816.687717, -6271997.028208, -4051823.281096], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mapa de densidades de pozos - SAR </h2>';
        return titleElement;
    })(),
